...
class bae_google_slides extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Google Slides', 'b-addon' );
	}

	public function get_icon() {
		return 'bl_icon eicon-thumbnails-down';
	}
	...
	protected function register_controls() {
		 ...
		 $this->start_controls_section(
            'section_content',
            [
                'label' => esc_html__( 'Google Slides Content', 'b-addon' )
            ]
        );
		...
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Google Slides Setting', 'b-addon' ),
            ]
        );
		...
		$this->add_control(
            'file_name_text', [
                ...
                'default'        => esc_html__( 'Slides Test File', 'b-addon' ),
                'condition' => [
                    'file_name' => 'yes'
                ]
            ]
